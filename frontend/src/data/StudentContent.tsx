...
const features:FeatureProps[] = [
    ...
    {
        title: 'Find your scholarships of interest with search filters such as benefits, courses, and schools.',
    ...
    {
        title: 'Learn about scholarships offered by different Scholarship Granting Organizations (SGOs)',
