...
class UserPermissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_permission" do
    assert_difference("UserPermission.count") do
      post user_permissions_url, params: { user_permission: { can_add: @user_permission.can_add, can_delete: @user_permission.can_delete, can_edit: @user_permission.can_edit, can_view: @user_permission.can_view, is_enabled: @user_permission.is_enabled, user_id: @user_permission.user_id, user_type: @user_permission.user_type } }
    end
  ...
  test "should update user_permission" do
    patch user_permission_url(@user_permission), params: { user_permission: { can_add: @user_permission.can_add, can_delete: @user_permission.can_delete, can_edit: @user_permission.can_edit, can_view: @user_permission.can_view, is_enabled: @user_permission.is_enabled, user_id: @user_permission.user_id, user_type: @user_permission.user_type } }
